...
const PaymentMethodList = ({ paymentmethoddata, onPaymentmethodEdit, onPaymentmethodDelete }) => {
                            ...
                            <tr key={paymentmethod.id} className="hover:bg-gray-50 transition-colors">
                                ...
                                <td className="px-3.5 py-3 text-center">
                                    <div className="flex items-center justify-center space-x-1.5">
                                        <button
                                            type="button"
                                            onClick={() => onPaymentmethodEdit?.(paymentmethod)}
                                        ...
                                        <button
                                            type="button"
                                            onClick={() =>  onPaymentmethodDelete?.(paymentmethod)}
