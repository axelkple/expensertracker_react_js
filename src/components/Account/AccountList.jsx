...
const AccountList = ({ accountdata, onAccountEdit, onAccountDelete }) => {
  ...
  if (accountdata.length === 0) {
    return (
      <div className="text-center py-8 text-gray-500 bg-white rounded-xl shadow border border-gray-100">
        ...
        <p className="text-sm text-gray-400">Add an account using the form on the left.</p>
      </div>
    );
  }
        ...
        <table className="w-full text-left">
          <thead>
            <tr className="bg-gradient-to-r from-blue-50 to-purple-50 border-b border-gray-200">
              ...
              <th className="px-3.5 py-3 text-xs font-semibold text-gray-700">Type</th>
              <th className="px-3.5 py-3 text-xs font-semibold text-gray-700">Balance</th>
              <th className="px-3.5 py-3 text-xs font-semibold text-gray-700">Currency</th>
